...
def test_best_action_from_rollout(tmp_path):
    ...
    mock_rollout_actions = [[[0,1,5],[0,1,2],[0,1,3],[0,1,4],[100,0,0]],
                            [[0,1,1],[0,1,2],[0,1,3],[100,0,0]],
                            [[0,2,104],[0,2,1],[0,2,2],[0,2,3],[0,2,4],[0,2,5],[100,0,0]],
                            [[0,1,1],[2,1,2],[100,0,0]]]
    assert root._best_action_from_rollout(mock_rollout_actions) == [[0,2,104],[0,2,1],[0,2,2],[0,2,3],[0,2,4],[0,2,5],[100,0,0]]